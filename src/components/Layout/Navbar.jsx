    ...
    return (
        <>
            <div className='hidden lg:block'>
                <div className='hidden lg:flex w-full justify-between bg-primary text-white px-10 xl:px-40 py-4'>
                    ...
                    <div className='flex items-center'>
                        ...
                        <div className='flex items-center'>
                            <select className='outline-none  px-1 py-1 rounded-sm bg-primary'>
                ...
                <div className="flex items-center justify-between  border-b px-4 py-2 md:px-6 xl:px-40 ">
                    ...
                    <div className='block lg:hidden '>
                        ...
                        >
                            ...
                            {/* Menu Icon */}
                            <RiMenu3Line className={`absolute text-3xl text-primary transition-all duration-300
                          ${open ? "opacity-0 rotate-90" : "opacity-100 rotate-0"}
                        `}
                            />

                            {/* Close Icon */}
                            <VscChromeClose className={`absolute text-3xl text-primary transition-all duration-300
                         ${open ? "opacity-100 rotate-0" : "opacity-0 -rotate-90"}
                       `}
                            />
                        </button>
                        <div className={`absolute bg-primary text-white mt-6 w-full py-2 left-0 transition-all duration-200 ease-in-out overflow-hidden
                        ${open
                            ...
                            `}>
                                ...
                                {dropdowns.Academics && (
                                    <div className=" left-0 w-full rounded-sm bg-primary text-white transition-all duration-200 cursor-pointer">
                                        <a href="">
                                            <p className="pl-9 py-2 text-md hover:text-gray-400">
                                                Faculties-Programs-Centers-Labs
                                            </p>
                                        </a>
                        ...
                        <ul className='flex gap-6 items-center text-primary font-medium'>
                            ...
                            <li className="relative">
                                ...
                                >
                                    ...
                                    {activeMenu === "academics" && (
                                        <div className="absolute top-full left-0 w-72 rounded-sm bg-primary text-white cursor-pointer">
                                            <a href="">
                                                <p className="px-4 py-2 hover:bg-blue-900">Faculties-Programs-Centers-Labs</p>
                                            </a>
                                            <a href="">
                                                <p className="px-4 py-2 hover:bg-blue-900">
                                                    Student-Handbook
                            ...
                            <li className="relative">
                                ...
                                >
                                    ...
                                    {activeMenu === "Course" && (
                                        <div className="absolute top-full left-0 w-56 rounded-sm bg-primary text-white cursor-pointer">
                                            <a href="">
                                                <p className="px-4 py-2 hover:bg-blue-900">Informasion technology</p>
                                            </a>
                                            <a href="">
                                                <p className="px-4 py-2 hover:bg-blue-900">
                            ...
                            <li className="relative">
                                ...
                                >
                                    ...
                                    {activeMenu === "tuition" && (
                                        <div className="absolute top-full left-0 w-32 rounded-sm bg-primary text-white cursor-pointer">
                                            <a href="">
                                                <p className="px-4 py-2 hover:bg-blue-900">Tuition-Fees</p>
                                            </a>
                                            <a href="">
                                                <p className="px-4 py-2 hover:bg-blue-900">
                                                    Other-Fees
